...
const lightTheme = {
    colors: {
      ...
      buttonText: '#ffffff',
      text: '#000000',
      petTitleBackground: '#D1C4E9', // light purple
    },
  };
  ...
  const darkTheme = {
    colors: {
      ...
      buttonText: '#282828',
      text: '#FFD700',
      petTitleBackground: '#1C1C1C', // dark gray or black
    },
  };
      ...
      <Container>
        <ScrollView contentContainerStyle={{ paddingBottom: 20 }}> 
         ...
         <View testID='catCareTips'>
            <Image source={{ uri: 'https://images.unsplash.com/photo-1482434368596-fbd06cae4f89?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' }} style={{ width: '100%', height: 400 }}/>
            <ContentSection>
